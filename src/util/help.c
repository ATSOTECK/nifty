...
void printHelp(const char *cmd) {
    ...
    if (str_eq(cmd, "new") || printAll) {
        ...
        printStrsWithSpacer("\tProject version", '-', "Starting version of the project. May not contain whitespace. Optional.", width);
        ...
        printStrsWithSpacer("\t--no-git", '-', "Creates the project without initializing a git repository.", width);
